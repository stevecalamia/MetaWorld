(function( $ ){
 ...
 // console.log("Init cloud"+i+".");
   ...
   // console.log("New cloud named cloud"+i, ".");
    ...
    cloud =  "<div id='cloud"+i+"' class='cloud cloud"+i+" container master'>";
    cloud += "  <div id='cloud"+i+"-front-container' class='cloud cloud"+i+" container minor front'>";
    cloud += "    <div id='cloud"+i+"-front-top' class='cloud cloud"+i+" contents front top'>&nbsp;</div>";
    cloud += "    <div id='cloud"+i+"-front-bottom' class='cloud cloud"+i+" contents front bottom'>&nbsp;</div>";
    cloud += "  </div>";
    cloud += "  <div id='cloud"+i+"-main-container' class='cloud cloud"+i+" container minor main'>";
    cloud += "    <div id='cloud"+i+"-main-top' class='cloud cloud"+i+" contents main top'>&nbsp;</div>";
    cloud += "    <div id='cloud"+i+"-main-mid' class='cloud cloud"+i+" contents main mid'>&nbsp;</div>";
    cloud += "    <div id='cloud"+i+"-main-bottom' class='cloud cloud"+i+" contents main bottom'>&nbsp;</div>";
    cloud += "  </div>";
    cloud += "  <div id='cloud"+i+"-body-mid' class='cloud cloud"+i+" contents body mid'>&nbsp;</div>";
    cloud += "  <div id='cloud"+i+"-body-bottom' class='cloud cloud"+i+" contents body bottom'>&nbsp;</div>";
    cloud += "</div>";
